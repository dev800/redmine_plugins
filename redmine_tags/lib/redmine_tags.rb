...
require 'redmine_tags/patches/add_helpers_for_issue_tags_patch'
require 'redmine_tags/patches/auto_completes_controller_patch'
require 'redmine_tags/patches/issue_patch'
require 'redmine_tags/patches/issue_query_patch'
require 'redmine_tags/patches/queries_helper_patch'
require 'redmine_tags/patches/time_entry_query_patch'
require 'redmine_tags/patches/time_report_patch'
if Redmine::Plugin.installed?(:redmine_agile) &&
  ...
  require 'redmine_tags/patches/agile_query_patch'
  require 'redmine_tags/patches/agile_versions_query_patch'
end

require 'query_tags_column'
require 'redmine_tags/patches/reports_controller_patch'
require 'redmine_tags/hooks/views_reports_hook'

module RedmineTags
  def self.settings() Setting[:plugin_redmine_tags].stringify_keys end
end
