...
unless TimeEntryQuery.included_modules.include?(RedmineTags::Patches::TimeEntryQueryPatch)
  TimeEntryQuery.send(:include, RedmineTags::Patches::TimeEntryQueryPatch)
end
