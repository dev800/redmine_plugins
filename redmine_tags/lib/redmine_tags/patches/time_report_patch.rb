...
unless Redmine::Helpers::TimeReport.included_modules.include?(RedmineTags::Patches::TimeReportPatch)
  Redmine::Helpers::TimeReport.send(:include, RedmineTags::Patches::TimeReportPatch)
end
