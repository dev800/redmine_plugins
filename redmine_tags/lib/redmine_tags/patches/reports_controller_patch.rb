...
unless ReportsController.included_modules.include?(RedmineTags::Patches::ReportsControllerPatch)
  ReportsController.send(:include, RedmineTags::Patches::ReportsControllerPatch)
end
