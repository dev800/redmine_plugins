...
if Redmine::Plugin.installed?(:redmine_agile) &&
  ...
  unless AgileVersionsQuery.included_modules.include?(RedmineTags::Patches::AgileVersionsQueryPatch)
    AgileVersionsQuery.send(:include, RedmineTags::Patches::AgileVersionsQueryPatch)
  end
